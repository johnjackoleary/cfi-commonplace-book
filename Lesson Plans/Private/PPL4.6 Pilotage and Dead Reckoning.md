...
---
### Introduction
Today we tend to rely on GPS as our primary method of navigation, but it's very important to learn and demonstrate Pilotage and Dead Reckoning as fundamental skills that cross-check our electronic methods, may be needed in an emergency, and are certainly required in aircraft without GPS receivers.

**Pilotage** is the practice of navigation by reference to landmarks and checkpoints.

**Dead Reckoning** is the practice of navigation solely by computations based on time, airspeed, distance, and direction.

Both require an understanding of compass corrections and wind corrections when planning and executing a route.
...
**Completing a Full Navlog**
1. How to handle step climbs under a Bravo
2. Various Flight Planners / Navigation Logs are available
	1. Done by hand
...
**What's Expected on the Checkride**
1. Knowledge:
	1. Magnetic compass errors (variation vs deviation; magnetic dip)
	2. Route planning (waypoints, altitudes, checkpoints)
	3. Making a navigation plan, including all wind corrections using E6B
2. Practice:
