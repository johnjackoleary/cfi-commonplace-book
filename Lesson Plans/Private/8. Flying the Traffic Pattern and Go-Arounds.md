...
4. Power, Airspeed, and Config for `=this.config.aircraft.model`
	1. Downwind Leg: `=this.config.aircraft.pattern-downwind-rpm` RPM, `=this.config.aircraft.pattern-downwind-kias`kts
	2. Abeam Threshold: `=this.config.aircraft.pattern-abeam-rpm` RPM, `=this.config.aircraft.pattern-abeam-kias`kts, flaps `=this.config.aircraft.pattern-abeam-flaps`
	3. Base Leg: `=this.config.aircraft.pattern-base-rpm` RPM, `=this.config.aircraft.pattern-base-kias`kts, flaps `=this.config.aircraft.pattern-base-flaps`
