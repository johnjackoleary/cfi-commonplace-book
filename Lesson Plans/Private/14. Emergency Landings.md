...
4. [[ABCDE]]
	1. Airspeed - best glide (in `= this.datasheet.model`, `= this.datasheet.vg`kts)
	...
	5. Execute emergency landing
		...
		2. Get to key point: Spiral descent, then rectangular pattern (if altitude permits) ![[Key Position for Power Off 180.jpeg]]
5. Details on flying the approach
	1. Effects of headwinds/tailwinds
	2. Aircraft configuration, such as gear and flaps
	6. Keep altitude, and plan to use [[11. Forward Slips to Landing|forward slip]] to control touchdown location
	7. Don't try to stretch a glide!
	8. Securing fuel and electrical systems before landing
	9. Unlatch doors before touchdown
	10. Maintain aircraft control all the way through the landing -- controlled landing in bad terrain is better then uncontrolled landing in good terrain
