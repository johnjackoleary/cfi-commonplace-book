...
---
### Objective
Continuing in the theme of "things that can go wrong during a cross-country flight", this lesson covers 'Lost Procedures' and 'Diversion to Alternatives.'  Both of these terms have specific meanings to an examiner, so we'll learn not only how to handle these situations in real life, but also to demonstrate what the examiner wants to see.

**Lost Procedures:** In the era of GPS it's harder than ever to get lost, but it's still possible.  The GPS system can fail or be jammed; your devices can run out of battery or overheat; you could have an electrical failure that requires turning off the avionics.  As pilots we need to ability the determine our own location without the blue dot.

**Diversion:** Diversion is a very real scenario.  You might be running low on fuel, or a passenger needs a bathroom.  Changing the plan en route happens all the time, and the replanning can be difficult for the new pilot in the cramped space of the cockpit, with the distractions of a plane to fly.

But we have a procedure to follow for each of these.  Let's look at them.
