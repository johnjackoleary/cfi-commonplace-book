...
### Introduction
During takeoff, a lot happens in a short period of time. The pilot needs to make final configuration changes and checks, taxi with crosswinds in mind, make radio calls, steer with the rudder, confirm engine performance, and be ready to abort if something isn't right. As always, having checklists and following them (in this case, from memory) is very important. In this lesson we'll first look at the aerodynamics of takeoffs (which the examiner expects you to understand), the preparation (do you have enough runway?), and the actual procedure. We'll also talk about how a takeoff in the presence of crosswinds differs.
...
7. Emergency Considerations
	...
	4. Reasons **not** to reject: an open window or door, or anything that can be fixed easily either in the air or by coming back promptly for a landing
8. Common Errors
